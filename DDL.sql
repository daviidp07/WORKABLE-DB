...
CREATE TABLE INFO_PERSONAL (
    ...
    CONSTRAINT FK_PE_USR_ID FOREIGN KEY (USR_ID) REFERENCES USUARIO(USR_ID)
); # por lo que aca era relacion 1:1 ya no era necesario que tuviera como ID un id unico es mejor a la tabla que esta relacionada por eso usr_id
